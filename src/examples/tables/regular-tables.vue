<template>
  <div>
    <div class="mb-5">
      <h4 class="heading-2 pb-4">Vue Bootstrap Tables</h4>
      <div class="card card-box mb-5 p-3">
        <b-form-group label="Table Options">
          ...
          <b-form-checkbox v-model="footClone" inline
    ...
    <table
      class="table table-hover table-striped table-bordered table-dark mb-5"
    >
    ...
    <h4 class="heading-2 pb-4">Alternate</h4>
      ...
      <tbody>
        <tr>
          ...
          <td class="text-center">
            ...
            <a
              href="javascript:void(0)"
              class="btn btn-outline-danger pl-2 pr-2 btn-sm ml-1 mr-1"
              title="Remove"
            >
...
library.add(faArrowRight, faArrowUp, faBinoculars, faTrashAlt);
