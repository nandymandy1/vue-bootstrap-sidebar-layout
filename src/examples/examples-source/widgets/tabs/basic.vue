    ...
    <b-tabs content-class="pt-4">
      <b-tab title="Overview" active>
        ...
        <p>
          ...
          sodales ullamcorper vehicula. Duis placerat quam porta lorem lobortis,
          sit amet sodales mauris finibus. Donec posuere diam at volutpat
          viverra.
        </p>
      </b-tab>
      <b-tab title="Sign in">
        ...
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum
          sodales ullamcorper vehicula. Duis placerat quam porta lorem lobortis,
          sit amet sodales mauris finibus.
        </p>
      </b-tab>
