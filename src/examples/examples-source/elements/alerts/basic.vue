<template>
  <div>
    ...
    >
      ...
      <span>
        <strong class="d-block">Success!</strong> This is a success alert—check
        it out!
      </span>
    </b-alert>
    <b-alert
    ...
    >
      ...
      <span>
        <strong class="d-block">Info!</strong> This is an info alert—check it
        out!
      </span>
    </b-alert>
    <b-alert
    ...
    >
      ...
      <span>
        <strong class="d-block">Warning!</strong> This is a warning alert—check
        it out!
      </span>
    </b-alert>
    <b-alert
    ...
    >
      ...
      <span>
        <strong class="d-block">Danger!</strong> This is an error alert—check it
        out!
      </span>
    </b-alert>
